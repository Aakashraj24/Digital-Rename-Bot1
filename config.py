...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7388338004:AAFKPRIsMR6rCrYy5rGww_CJLGGOYHYfPMs") 
    ...
    DB_URL = os.environ.get("DB_URL","mongodb+srv://aakashrajbhar124:7J6g30Byf5vitAfg@kohdeylop.5jvl2pr.mongodb.net/?retryWrites=true&w=majority&appName=Kohdeylop")
 
    # other configs
    RKN_PIC = os.environ.get("RKN_PIC", "https://telegra.ph/file/b746aadfe59959eb76f59.jpg")
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '5300021755').split()]
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002176855169")

    #force subs
    try:
        FORCE_SUB = int(os.environ.get("FORCE_SUB", "koh_premium_bots")) 
    except:
